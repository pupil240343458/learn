...
<%
    ...
    //request.getRequestDispatcher("request.jsp").forward(request,response);请求转发：服务器行为，request.getRequestDispatcher().forward(req,resp)；是一次请求，转发后请求对象会保存，地址栏的URL地址不会改变。
%>
</body>
</html>
